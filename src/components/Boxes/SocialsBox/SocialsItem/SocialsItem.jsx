const variantMap = {
  def: 'py-2 w-1/4 bg-black border-white sm:w-full sm:h-full flex items-center justify-center',
  ...
  facebook: 'border-r-2 !border-black bg-white  xl:border-r-2',
  linkedin: 'border-r-2 !border-black bg-white',
  youtube: 'border-r-2 !border-black bg-white',
  email: 'bg-white',
};
