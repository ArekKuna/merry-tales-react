const variantMap = {
  def: 'pt-header border-black min-h-screen border-2 border-black xl:max-w-screen xl:max-h-screen',
  grid: 'grid grid-cols-1 grid-rows-3 sm:grid-cols-2 sm:grid-rows-3 xl:max-h-screen xl:grid-cols-8 xl:grid-rows-5',
  flex: 'flex flex-col items-center bg-ghostWhite xl:justify-between xl:justify-evenly',
};
